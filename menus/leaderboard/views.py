...
from . import characterleaderboard, ppeleaderboard, questleaderboard, seasonleaderboard, teamleaderboard


def leaderboard_home_embed() -> discord.Embed:
    embed = discord.Embed(
        title="Leaderboards",
...
class CharacterLeaderboardClassView(OwnerBoundView):
    ...
    async def back(self, interaction: discord.Interaction, _button: discord.ui.Button) -> None:
        home_view = LeaderboardHomeView(owner_id=interaction.user.id)
