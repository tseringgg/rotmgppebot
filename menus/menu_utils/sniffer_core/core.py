...
def _utc_iso_now() -> str:
    return realmshark_common.utc_iso_now()


def _token_preview(token: str) -> str:
    return realmshark_common.token_preview(token)
